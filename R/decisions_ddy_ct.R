...
#' decision per department per member state per year (directed dyad-year data)
...
#' decision type (1988-2020), excluding directed dyad-years where the state
#' was not a member of the EU. The dataset uses current department names.
#' 
