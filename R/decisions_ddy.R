...
#' decision per department per member state per year (directed dyad-year
#' data). There is one observation per department per member state per year
#' per decision type (1988-2020), excluding directed dyad-years where the
