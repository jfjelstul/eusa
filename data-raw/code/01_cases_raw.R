...
# variable names
names(cases_raw) <- c(
  "case_number", "procedure_numbers", "case_title", "case_title_original",
  "member_state", "regions", "nace_codes", "aid_instruments", "case_type",
  "start_date", "end_date", "notification_date",
  "decisions", "objectives", "outcome_date", "citations", "related_cases", "department",
  "expenditures"
)
...
# save
save(cases_raw, file = "data-raw/working-files/cases_raw.RData")
