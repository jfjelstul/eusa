...
departments <- dplyr::tibble(
  department_id = c(89, 127, 139),
  department = c("Directorate-General for Competition", "Directorate-General for Agriculture and Rural Development", "Directorate-General for Maritime Affairs and Fisheries"),
  department_code = c("COMP", "AGRI", "MARE")
)
