...
# DG ID
cases$directorate_general_ID <- 0
cases$directorate_general_ID[cases$directorate_general == "Agriculture and Rural Development"] <- 2
cases$directorate_general_ID[cases$directorate_general == "Competition"] <- 1
cases$directorate_general_ID[cases$directorate_general == "Maritime Affairs and Fisheries"] <- 3
...
cases$outcome[cases$formal_investigation == 1] <- NA
